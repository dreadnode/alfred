...
CAPABILITIES: dict[str, _CapabilityDef] = {
    ...
    "lit-review": {
        "description": "Full literature review (uses search-sources + analyze-source)",
...
def maybe_expand_command(user_input: str) -> str:
    ...
    return (
        ...
        f"When these instructions request output under capabilities/reports/, "
        f"use save_capability_report with only the report filename. Never create "
        f"a capabilities/ or absolute repository path inside the paper directory.\n"
