...
7. **Surface the review as an artifact**: Call `emit_file_artifact` with the review record path and label "Peer Review Record" so the user gets a clickable card in the chat to copy the full review.
